...
class TestMarketStock(unittest.TestCase):
    ...
    @patch("app.api.v1.market.stock.yq")
    ...
    @patch("app.api.v1.market.stock.yf")
    ...
    @patch("app.api.v1.market.stock.get_symbol_df")
    def test_get_symbol_data(self, mock_get_symbol_df):
        ...
        mock_get_symbol_df.assert_called_once_with(
            name="AAPL", period="1y", interval="1d"
        )
    ...
    def test_get_symbol_data_default_parameters(self, mock_get_symbol_df):
        ...
        mock_get_symbol_df.assert_called_once_with(
            name="AAPL", period="max", interval="1d"
        )
    ...
    def test_data_types(self):
        ...
        with patch("app.api.v1.market.stock.yf") as mock_yf:
            mock_ticker = MagicMock()
            mock_ticker.history.return_value = self.sample_df
            mock_yf.Ticker.return_value = mock_ticker
