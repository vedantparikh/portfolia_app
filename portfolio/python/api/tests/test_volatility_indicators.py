...
class TestVolatilityIndicators(unittest.TestCase):
    ...
    def test_average_true_range_indicator(self):
        ...
        self.assertTrue(all(atr >= 0 for atr in pd_result['average_true_range'].dropna()))
    ...
    def test_edge_cases(self):
        ...
        try:
            result = small_volatility.bollinger_bands_indicator(window=2, window_dev=1, fillna=True)
