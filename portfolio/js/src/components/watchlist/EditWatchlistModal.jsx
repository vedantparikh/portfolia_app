...
const EditWatchlistModal = ({ isOpen, onClose, watchlist, onUpdate }) => {
    ...
    useEffect(() => {
        if (watchlist) {
            setFormData({
                ...
                is_default: watchlist.is_default || false,
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await onUpdate(watchlist.id, formData);
            handleClose();
        } catch (error) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-dark-900 border border-dark-700 rounded-lg w-full max-w-md mx-4">
                ...
                <div className="flex items-center justify-between p-6 border-b border-dark-700">
                    <h2 className="text-lg font-semibold text-gray-100">Edit Watchlist</h2>
                    <button
                        onClick={handleClose}
